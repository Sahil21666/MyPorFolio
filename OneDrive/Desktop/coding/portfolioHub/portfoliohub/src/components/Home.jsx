...
function Home() {
  ...
  return (
    <div className="flex flex-col lg:flex-row justify-center items-center p-5 animate-fade-in duration-300">
    {/* Image Section */}
    ...
    {/* Text Section */}
    <div className="w-full lg:w-2/4 text-center flex flex-col justify-center items-center p-2">
